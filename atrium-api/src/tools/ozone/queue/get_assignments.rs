...
//!Definitions for the `tools.ozone.queue.getAssignments` namespace.
pub const NSID: &str = "tools.ozone.queue.getAssignments";
...
pub struct OutputData {
    pub assignments: Vec<crate::tools::ozone::queue::defs::AssignmentView>,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub cursor: core::option::Option<String>,
}
